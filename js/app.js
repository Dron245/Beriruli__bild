(() => {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".ddd")) new core(".catalogbu__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        window.onload = function() {
            ...
            if (window.innerWidth > 991.98 && document.querySelector(".catalogbu__slider")) document.querySelector(".catalogbu__slider").classList.remove("ddd");
        };
        ...
        const cardsData = [ {
            id: 1,
            condition: "С пробегом 2 водителя",
            title: "Ваз",
            year: 2006,
            options: "Безналичный расчёт",
            transmission: "Механика"
        }, {
            id: 2,
            condition: "С пробегом 1 водитель",
            title: "Волга",
            year: 2010,
            options: "Безналичный расчёт",
            transmission: "Механика"
        ...
        if (document.querySelector(".catalogjs")) {
            ...
            function documentactions(e) {
                ...
                if (isMobile.any()) if (targetElement.classList.contains("menu__link-button")) targetElement.closest(".menu__item").classList.toggle("_hover");
                if (targetElement.closest("._close")) arrow.forEach((element => {
                    element.classList.add("hidden");
                    element.classList.remove("openarrow");
                }));
                if (targetElement.closest("._open")) arrow.forEach((element => {
                    element.classList.add("openarrow");
                    element.classList.remove("hidden");
                }));
                if (targetElement.closest(".checkbox")) meh.forEach((element => {
                    element.classList.toggle("active");
                }));
                if (document.body.offsetWidth > 768) {
                    if (targetElement.closest(".select__options")) if (targetElement.closest('[data-id="1"]') && !selectOne.querySelector(".filter__tablet")) selectOne.insertAdjacentHTML("beforeend", `<div class="filter__tablet">${table}</div>`);
                    if (targetElement.closest(".select__options")) if (targetElement.closest('[data-id="2"]') && !selectTwo.querySelector(".filter__tablet")) selectTwo.insertAdjacentHTML("beforeend", `<div class="filter__tablet">${table}</div>`);
                    if (targetElement.closest(".select__options")) if (targetElement.closest('[data-id="3"]') && !selectThree.querySelector(".filter__tablet")) selectThree.insertAdjacentHTML("beforeend", `<div class="filter__tablet">${table}</div>`);
                    if (targetElement.closest(".select__options")) if (targetElement.closest('[data-id="4"]') && !selectFour.querySelector(".filter__tablet")) selectFour.insertAdjacentHTML("beforeend", `<div class="filter__tablet">${table}</div>`);
                    if (targetElement.closest('[data-id="1"]')) if (targetElement.closest(".select__options") && targetElement.innerHTML !== selectOne.querySelector(".filter__options").innerHTML) {
                        selectOne.querySelector(".filter__tablet").remove();
                        selectOne.insertAdjacentHTML("beforeend", `<div class="filter__tablet">${table}</div>`);
                    }
                    if (targetElement.closest('[data-id="2"]')) if (targetElement.closest(".select__options") && targetElement.innerHTML !== selectTwo.querySelector(".filter__options").innerHTML) {
                        selectTwo.querySelector(".filter__tablet").remove();
                        selectTwo.insertAdjacentHTML("beforeend", `<div class="filter__tablet">${table}</div>`);
                    }
                    if (targetElement.closest('[data-id="3"]')) if (targetElement.closest(".select__options") && targetElement.innerHTML !== selectThree.querySelector(".filter__options").innerHTML) {
                    ...
                    if (targetElement.closest('[data-id="4"]')) if (targetElement.closest(".select__options") && targetElement.innerHTML !== selectFour.querySelector(".filter__options").innerHTML) {
                ...
                if (targetElement.closest(".filter__button")) {
                    ...
                    for (let i = 0; i < clearFull.length; i++) clearFull[i].remove();
            ...
            for (let i = 0; i < newGreen.length; i++) {
                ...
                if ("Новое" === element) newGreen[i].classList.add("_green");
            }
            ...
            function filtersearch() {
                ...
                let filteredCardsData = cardsData.filter((card => {
                    if (rgx.test(card.title)) return true; else return false;
                }));
                ...
                if (e.target.closest('[data-id="1"]')) {
                    ...
                    function aaa(e) {
                        ...
                        const filteredCards = cardsData.filter((card => {
                            ...
                            console.log(reg);
                            if (reg.test(card.options)) return true; else return false;
                        }));
            ...
            function asd(e) {
                if (e.target.closest('[data-id="2"]')) {
                    ...
                    function filterCondition(e) {
                        ...
                        const filteredCards = cardsData.filter((card => {
                            const reg = new RegExp(value);
                            if (reg.test(card.condition)) return true; else return false;
                        }));
                        results.innerHTML = generateCard(filteredCards).join("");
                    }
                }
                ...
                if (e.target.closest('[data-id="3"]')) {
                    ...
                    function iop(e) {
                        ...
                        const vbn = cardsData.filter((card => {
                            if (card.year >= value) return true; else return false;
                        }));
            ...
            function check() {
                setTimeout((function() {
                    ...
                    let checks = cardsData.filter((card => {
                        if (rgx.test(card.transmission)) return true; else return false;
                    }));
                    results.innerHTML = generateCard(checks).join("");
                }), 10);
            }
            document.querySelectorAll(".selectq").forEach((select => {
                let selectCurrent = select.querySelector(".selectq__current"), selectList = select.querySelector(".selectq__list"), selectInput = select.querySelector(".selectq__input"), selectItem = select.querySelectorAll(".selectq__item");
            ...
            const filterstype = [ "options", "condition" ];
            function filterselect(filtertype) {
                filters[filtertype].addEventListener("DOMSubtreeModified", (e => {
                    ...
                    const filteredCards = cardsData.filter((card => {
                        const reg = new RegExp(value);
                        if (reg.test(card[filtertype])) return true; else return false;
                    }));
            ...
            function checkOtherFilters(filterstype, filteredCards) {
                ...
                filterstype.forEach((type => {
                    ...
                    const newFilteredCards = updatedFilteredCards.filter((card => {
                        if (reg.test(card[type])) return true; else return false;
                    }));
